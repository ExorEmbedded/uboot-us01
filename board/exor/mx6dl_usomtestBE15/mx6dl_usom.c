...
#define ENVDD_GPIO IMX_GPIO_NR(7, 1)
#define ENBL_GPIO  IMX_GPIO_NR(7, 0)
#define DIMM_GPIO  IMX_GPIO_NR(1, 9)
...
int board_late_init(void)
{
  ...
  if(read_eeprom())
    printf("Failed to read the HW cfg from the I2C SEEPROM.\n");
...
void ena_rs232phy(void)
{
  ...
  gpio_request(ENVDD_GPIO,"");
  gpio_direction_output(ENVDD_GPIO,1);
  
  gpio_request(ENBL_GPIO,"");
  gpio_direction_output(ENBL_GPIO,1);

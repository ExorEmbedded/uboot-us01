...
#define ADDR_LEDREG  					(0x1A803050)

//------------------------------------------------------------------------------------
// Light EVC core
//------------------------------------------------------------------------------------
#define EVC_BASE_ADDRESS				(0x1A800000)
#define EVC_SCTRL_ADDRESS				(0x1A800020)
#define EVC_CLKCTRL_ADDRESS				(0x1A800024)
#define EVC_PWRCTRL_ADDRESS				(0x1A80002C)

#define EVC_ENVOLTAGE_MASK				(0x06)
#define EVC_ENVIDEO_MASK				(0x01)
#define EVC_ENBLIGHT_MASK				(0x08)
#define EVC_CLKINV_MASK					(0x80)

// GenREG out register for enabling the RS232 TX phy
#define ADR_GENREG_OUT             		(0x1A803410)

/* ULTIADDA base address */
#define CONFIG_ULTIADDA_BASE	 		(0x1A000000 + 0xC00000)
...
#define MUX_UN30() \
 ...
 MUX_VAL(CP(SYS_BOOT5),		(IEN  | PTU | EN | M0)) /*GPIO_7*/\

...
void ddr_cfg_phy(void) {
	...
	reg32_write(0x3c0801f4,0x212);
	reg32_write(0x3c0801f0,0x61);
	reg32_write(0x3c040128,0x500);
	reg32_write(0x3c044128,0x500);
	reg32_write(0x3c0800b0,0x0);
	...
	reg32_write(IP2APB_DDRPHY_IPS_BASE_ADDR(0) + 4 * 0x54006,0x140);
	...
	reg32_write(IP2APB_DDRPHY_IPS_BASE_ADDR(0) + 4 * 0x5402f,0x1d70);
	...
	reg32_write(0x3c2400fc,0x633);
	reg32_write(0x3c240100,0x149);
	reg32_write(0x3c240104,0x4f);
	reg32_write(0x3c240108,0x633);
	...
	reg32_write(0x3c240260,0xb);
	reg32_write(0x3c240264,0x10);
	reg32_write(0x3c240268,0x109);
	reg32_write(0x3c24026c,0x1);
	reg32_write(0x3c240270,0x10);
	reg32_write(0x3c240274,0x109);
	reg32_write(0x3c240278,0x5);
	reg32_write(0x3c24027c,0x7c0);
	reg32_write(0x3c240280,0x109);
	reg32_write(0x3c240284,0x0);
	reg32_write(0x3c240288,0x8140);
	reg32_write(0x3c24028c,0x10c);
	reg32_write(0x3c240290,0x10);
	reg32_write(0x3c240294,0x8138);
	reg32_write(0x3c240298,0x10c);
	reg32_write(0x3c24029c,0x8);
	reg32_write(0x3c2402a0,0x7c8);
	reg32_write(0x3c2402a4,0x101);
	reg32_write(0x3c2402a8,0x8);
	reg32_write(0x3c2402ac,0x448);
	reg32_write(0x3c2402b0,0x109);
	reg32_write(0x3c2402b4,0xf);
	reg32_write(0x3c2402b8,0x7c0);
	reg32_write(0x3c2402bc,0x109);
	reg32_write(0x3c2402c0,0x47);
	reg32_write(0x3c2402c4,0x630);
	reg32_write(0x3c2402c8,0x109);
	reg32_write(0x3c2402cc,0x8);
	reg32_write(0x3c2402d0,0x618);
	reg32_write(0x3c2402d4,0x109);
	reg32_write(0x3c2402d8,0x8);
	reg32_write(0x3c2402dc,0xe0);
	reg32_write(0x3c2402e0,0x109);
	reg32_write(0x3c2402e4,0x0);
	reg32_write(0x3c2402e8,0x7c8);
	reg32_write(0x3c2402ec,0x109);
	reg32_write(0x3c2402f0,0x8);
	reg32_write(0x3c2402f4,0x8140);
	reg32_write(0x3c2402f8,0x10c);
	reg32_write(0x3c2402fc,0x0);
	reg32_write(0x3c240300,0x1);
	reg32_write(0x3c240304,0x8);
	reg32_write(0x3c240308,0x8);
	reg32_write(0x3c24030c,0x4);
	reg32_write(0x3c240310,0x8);
	reg32_write(0x3c240314,0x8);
	reg32_write(0x3c240318,0x7c8);
	reg32_write(0x3c24031c,0x101);

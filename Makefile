...
omap3_un30_config :	unconfig
	@$(MKCONFIG) $(@:_config=) arm arm_cortexa8 un30 omap3 omap3

am3517_un31f_config :	unconfig
	@$(MKCONFIG) $(@:_config=) arm arm_cortexa8 un31f ti omap3

am3517_un31p_config :	unconfig
	@$(MKCONFIG) $(@:_config=) arm arm_cortexa8 un31p ti omap3

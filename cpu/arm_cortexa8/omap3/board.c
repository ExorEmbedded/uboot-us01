...
//!!!
void  WriteDebugByte(unsigned char c)
{
  unsigned char* SSR_REG = 0x49020044;
  unsigned char* THR_REG = 0x49020000;
  while((*SSR_REG)&0x01);
  *THR_REG=c;
}

//!!!
void WriteDebugString(char* s)
{
  while(*s != '\0') 
  {
	WriteDebugByte(*s);

...
#if defined(CONFIG_OMAP3_UN30)
	writel(0x03588099,	&sdrc_base->cs[cs].mcfg);
	writel(0x4e201,		&sdrc_base->cs[cs].rfr_ctrl);
	writel(0xaa9db4c6,	&sdrc_actim_base->ctrla);
	writel(0x2014,		&sdrc_actim_base->ctrlb);
#else
